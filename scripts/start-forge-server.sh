...
DEFAULT_JAR_URL="https://maven.minecraftforge.net/net/minecraftforge/forge/1.20.1-47.3.0/forge-1.20.1-47.3.0-installer.jar"
...
# Modify the user_jvm_args.txt file
echo "-Xmx${JAVA_XMX:-4G}" > ./user_jvm_args.txt
